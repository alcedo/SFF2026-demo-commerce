...
- **Auto confirm.** Stay on checkout. It POSTs `/api/orders/<id>` every 2.5s. After about eight seconds the app moves to `/processing/<orderId>` (`Detecting your payment...`) and then `/success/<orderId>`.
